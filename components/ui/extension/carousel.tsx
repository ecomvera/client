    ...
    return (
      <Button
        ...
        className={cn(
          ...
          orientation === "vertical" ? "-top-2 left-1/2 -translate-x-1/2 rotate-90" : "-left-2 top-1/2 -translate-y-1/2",
          className
        )}
        onClick={scroll}
        disabled={!canScroll}
  ...
  ({ className, dir, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (
      <Button
        ...
        className={cn(
          "absolute h-6 w-6 rounded-full z-10",
          orientation === "vertical" ? "-bottom-2 left-1/2 -translate-x-1/2 rotate-90" : "-right-2 top-1/2 -translate-y-1/2",
          className
        )}
        onClick={scroll}
        disabled={!canScroll}
