...
export function LoadingScreen() {
  ...
  return (
    <Dialog open={showLoadingScreen}>
      <DialogContent
        className="w-fit h-fit p-0 flex items-center justify-center bg-transparent border-none outline-none shadow-none loading"
      ...
      <div className="truckWrapper">
        <div className="truckBody">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 198 93" className="trucksvg">
            ...
            <rect stroke-width="3" stroke="#282828" fill="#7D7C7C" rx="2.5" height="90" width="121" y="1.5" x="6.5"></rect>
