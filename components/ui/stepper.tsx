...
function StepperIndicator({ asChild = false, className, children, ...props }: StepperIndicatorProps) {
  ...
  return (
    <span
      ...
      className={cn(
        "bg-muted text-muted-foreground data-[state=active]:bg-[--c3] data-[state=completed]:bg-[--c3] data-[state=active]:text-primary-foreground data-[state=completed]:text-primary-foreground relative flex size-6 shrink-0 items-center justify-center rounded-full text-xs font-medium",
        className
      )}
      data-state={state}
      {...props}
